...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2014 a las 23:16:25
...
INSERT INTO `pagos` (`id`, `idusuario`, `monto`, `idtipo_de_pago`, `nro_referencia`, `idbanco`, `fecha`, `idEstado`) VALUES
...
INSERT INTO `pagos_bancos` (`id`, `nombre`) VALUES
(1, 'Otro'),
...
INSERT INTO `pagos_estados` (`id`, `nombre`) VALUES
(0, 'Pendiente'),
(1, 'Aprobado'),
(2, 'Rechazado');
...
INSERT INTO `pagos_tipos` (`id`, `nombre`) VALUES
(1, 'Depósito'),
(2, 'Transferencia');
...
ALTER TABLE `pagos`
  ...
  ADD CONSTRAINT `pagos_ibfk_1` FOREIGN KEY (`idtipo_de_pago`) REFERENCES `pagos_tipos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
